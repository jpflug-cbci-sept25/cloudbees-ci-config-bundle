...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/jpflug-cbci-sept25/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>jpflug-cbci-sept25</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>jpflug-cbci-sept25</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/jpflug-cbci-sept25/pipeline-template-catalog.git</repositoryUrl>
              <traits>
